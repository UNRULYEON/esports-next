...
export const Event = ({ data: event }: EventProps) => {
  ...
  return (
    <TooltipProvider>
      <div className="relative flex flex-col items-center gap-3 rounded-lg border-2 py-3 font-bold transition hover:bg-neutral-900">
        ...
        <Typography.Small className="font-bold uppercase text-muted-foreground">
        ...
        {!isMatchRevealed && (
          <button
            className="absolute bottom-0 left-0 right-0 top-0 flex cursor-pointer flex-col place-content-center items-center gap-2 rounded-md bg-background p-1.5 hover:bg-neutral-900"
